...
public class EmailUtil {
    ...
    public String setTextWithCode(String name, String code) {
        return "<h1>Chào mừng bạn đến với EduBoost</h1>"
    ...
    public String setTextWithReminder(String name, String eventTitle, String eventStartTime, String eventDate) {
        return "<h1>Chào " + name + "</h1>"
                + "<p>Đây là lời nhắc nhở về sự kiện " + eventTitle + " sắp diễn ra vào lúc " + eventStartTime
                + " ngày " + eventDate + "</p>"
                + "<p>Trân trọng,</p>"
                + "<p>Quản trị viên</p>";
    }
    ...
    public void sendReminderEmail(String to, String name, String eventTitle, String eventStartTime, String eventDate)
            throws MessagingException {
        sendHtmlEmail(to, "Nhắc nhở sự kiện", setTextWithReminder(name, eventTitle, eventStartTime, eventDate));
    }
